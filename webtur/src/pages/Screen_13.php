...
<form method="post" id="form_cad_hot" action="/webtur/src/pages/Screen_13.php">

<div class="Screen_5 MatcSreen">
  <div class="Headline_1">Cadastrar Casa de Show</div>
  ...
  <div class="Row_16">
    <div class="Label_4">Dias de Funcionamento</div>
    <input type="text" placeholder="Enter a value" class="Text_Box" id="id_tb_DF" name="name_tb_DF" />
  ...
  <div class="Row_17">
    <div class="Label_5">Horário</div>
    <input type="text" placeholder="Enter a value" class="Text_Box_1" id="id_tb_hora" name="name_tb_hora" />

    <div class="Label_8">Telefone</div>
    <input type="text" placeholder="Enter a value" class="Text_Box_4" id="id_tb_tel" name="name_tb_tel" />
...
if (isset($_POST["name_b1_inse"])) {
  ...
  if (empty($_POST["name_tb_codPT"]) || $_POST["name_tb_codPT"] == 'Preencha um nome')  {
    ...
    if (isset($_POST["name_tb_codPT"]) && isset($_POST["name_tb_DF"]) && isset($_POST["name_tb_hora"]) && isset($_POST["name_tb_tel"]) && isset($_POST["name_tb_foto"])){ 
      ...
      $DF = strtoupper($_POST['name_tb_DF']);

      $query = "INSERT INTO casashow VALUES ('".$_POST['name_tb_codPT']."','".$DF."','".$_POST['name_tb_hora']."','".$_POST['name_tb_tel']."','".$_POST['name_tb_foto']."')";
      ...
      if($id){
        ...
        if($sql){
          ...
          echo "<script>document.getElementById('id_tb_codPT').value ='Incluído!'</script>";
...
// "DELETE FROM `cidade` WHERE `cidade`.`codigo` = 7"
  ...
  if (empty($_POST["name_tb_codPT"])) {
    ...
    if (isset($_POST["name_tb_codPT"]) && isset($_POST["name_tb_DF"]) && isset($_POST["name_tb_hora"]) && isset($_POST["name_tb_tel"]) && isset($_POST["name_tb_foto"])){ 
      ...
      $query = "select * from casashow where codigoPT='".$pesq_oq."'";
      ...
      if($id){
        ...
        if($cod != ''){
          ...
          $query = "delete from casashow where codigoPT='".$cod."'";
          if($id){
            mysqli_select_db($id,$db);
            $sql = mysqli_query($id,$query) or die ($id->error);
    ...
    if (empty($_POST["name_tb_codPT"])) {
      ...
      if (isset($_POST["name_tb_codPT"]) && isset($_POST["name_tb_DF"]) && isset($_POST["name_tb_hora"]) && isset($_POST["name_tb_tel"]) && isset($_POST["name_tb_foto"])){ 
        ...
        if($id){
          ...
          while($dados = mysqli_fetch_array($sql)){
              ...
              $diaFunciona[$i] = $dados['diaFunciona'];
              echo "<script>document.getElementById('id_tb_DF').value ='".$diaFunciona[$i]."'</script>";
              $horario[$i] = $dados['horario'];
              echo "<script>document.getElementById('id_tb_hora').value ='".$horario[$i]."'</script>";
              $telefone[$i] = $dados['telefone'];
              echo "<script>document.getElementById('id_tb_tel').value ='".$telefone[$i]."'</script>";
              $foto[$i] = $dados['foto'];
      ...
      echo " Aqui será feito o UPDATE no registro achado<br>";
        ...
        $db = 'webtur';
         ...
         $query = "update casashow set codigoPT='".$_POST['name_tb_codPT']."', diaFunciona='".$_POST['name_tb_DF']."', horario='".$_POST['name_tb_hora']."', telefone='".$_POST['name_tb_tel']."', foto='".$_POST['name_tb_foto']."' where codigoPT='".$_POST['codG']."'";
          ...
          if($id){
            ...
            if($sql){
                echo "<script>document.getElementById('id_tb_codPT').value ='Casa de shows alterada!'</script>";
