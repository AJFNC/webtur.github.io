...
<form method="post" id="form_cad_rest" action="/webtur/src/pages/Screen_10.php">

<div class="Screen_5 MatcSreen">
  <div class="Headline_1">Cadastrar Restaurantes</div>
...
//  $query = "INSERT INTO restaurante VALUES ('','".$_POST['name_tb_nome']."','".$_POST['name_tb_end']."','".$_POST['name_tb_cat']."','".$_POST['name_tb_codc']."','".$_POST['name_tb_foto']."')";
...
if (isset($_POST["name_b1_inse"])) {
  ...
  if (empty($_POST["name_tb_nome"]) || $_POST["name_tb_nome"] == 'Preencha um nome')  {
    ...
    if (isset($_POST["name_tb_nome"]) && isset($_POST["name_tb_end"]) && isset($_POST["name_tb_cat"]) && isset($_POST["name_tb_codc"]) && isset($_POST["name_tb_foto"]) && isset($_POST["name_tb_telefone"])){ 
      ...
      $query = "INSERT INTO restaurante VALUES ('','".$nomeC."','".$_POST["name_tb_end"]."','".$_POST["name_tb_cat"]."','".$_POST['name_tb_codc']."','".$_POST['name_tb_foto']."','".$_POST['name_tb_telefone']."')";
    ...
    if (isset($_POST["name_tb_nome"]) && isset($_POST["name_tb_end"]) && isset($_POST["name_tb_cat"]) && isset($_POST["name_tb_codc"]) && isset($_POST["name_tb_foto"]) && isset($_POST["name_tb_telefone"])){  
      ...
      if($id){
        ...
        if($cod != ''){
          ...
          $query = "delete from restaurante where codigo='".$cod."'";
          if($id){
            mysqli_select_db($id,$db);
            $sql = mysqli_query($id,$query) or die ($id->error);
          ...
          echo "<script>document.getElementById('id_tb_nome').value ='Restaurante não encontrado!'</script>";
          echo "<script>document.getElementById('id_tb_nome').style.backgroundColor ='yellow'</script>";
    ...
    if (empty($_POST["name_tb_nome"])) {
      ...
      echo " Aqui será feito o UPDATE no registro achado<br>";
        ...
        // $query = "INSERT INTO hotel VALUES ('','".$nomeC."','".$_POST["name_tb_end"]."','".$_POST["name_tb_cat"]."','".$_POST['name_tb_codc']."','".$_POST['name_tb_foto']."','".$_POST['name_tb_telefone']."')";
         ...
         $query = "update restaurante set nome='".$_POST['name_tb_nome']."', endereco='".$_POST['name_tb_end']."', categoria='".$_POST['name_tb_cat']."', codigoCidade='".$_POST['name_tb_codc']."', foto='".$_POST['name_tb_foto']."', telefone='".$_POST['name_tb_telefone']."' where codigo='".$_POST['codG']."'";
          ...
          if($id){
            ...
            if($sql){
                echo "<script>document.getElementById('id_tb_nome').value ='Restaurante alterado!'</script>";
